...
infile2000 = 'nphaseIRI2012vsR_iono_iriri_2012_24537_night.lst2000.0.npz'
...
infile4000 = 'nphaseIRI2012vsR_iono_iriri_2012_24537_night.lst4000.0.npz'
...
infile6000 = 'nphaseIRI2012vsR_iono_iriri_2012_24537_night.lst6000.0.npz'
...
infile8000 = 'nphaseIRI2012vsR_iono_iriri_2012_24537_night.lst8000.0.npz'
...
infile10000 = 'nphaseIRI2012vsR_iono_iriri_2012_24537_night.lst10000.0.npz'
...
infile12000 = 'nphaseIRI2012vsR_iono_iriri_2012_24537_night.lst12000.0.npz'
...
infile14000 = 'nphaseIRI2012vsR_iono_iriri_2012_24537_night.lst14000.0.npz'
...
infile16000 = 'nphaseIRI2012vsR_iono_iriri_2012_24537_night.lst16000.0.npz'
...
infile18000 = 'nphaseIRI2012vsR_iono_iriri_2012_24537_night.lst18000.0.npz'
...
infile20000 = 'nphaseIRI2012vsR_iono_iriri_2012_24537_night.lst20000.0.npz'
...
infile22000 = 'nphaseIRI2012vsR_iono_iriri_2012_24537_night.lst22000.0.npz'
...
infile24000 = 'nphaseIRI2012vsR_iono_iriri_2012_24537_night.lst24000.0.npz'
...
infile26000 = 'nphaseIRI2012vsR_iono_iriri_2012_24537_night.lst26000.0.npz'
...
infile28000 = 'nphaseIRI2012vsR_iono_iriri_2012_24537_night.lst28000.0.npz'
...
infile30000 = 'nphaseIRI2012vsR_iono_iriri_2012_24537_night.lst30000.0.npz'
...
infile32000 = 'nphaseIRI2012vsR_iono_iriri_2012_24537_night.lst32000.0.npz'
...
ymax = 150.  # max y boundary for plotting
...
ymax = 60.  # max y boundary for plotting

#plt.axis([xmin,xmax,ymin,ymax])	

plt.plot(np.asarray(freq)/1.e3,np.asarray(bmaxPowerMinPer),label=r'min lig power - perigeum')
plt.plot(np.asarray(freq)/1.e3,np.asarray(bmaxPowerMaxPer),label=r'max lig power - perigeum')
plt.plot(np.asarray(freq)/1.e3,np.asarray(bmaxPowerMinApo),label=r'min lig power - apogeum',linestyle='--')
plt.plot(np.asarray(freq)/1.e3,np.asarray(bmaxPowerMaxApo),label=r'max lig power - apogeum',linestyle='--')
